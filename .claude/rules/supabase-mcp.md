...
| `picks` | ~254 | `id`, `user_id`, `draw_id`, `match_id`, `match_pick`, `original_pick`, `original_pick_result` (correct/wrong), `match_pick_result` (correct/wrong), `high_confidence`, `edited_after_lock` |
